        ...
        <div v-if="open" class="space-y-5 border-t-2 border-foreground/10 px-4 pb-4 pt-4">
            <div v-if="socialAccount" class="flex items-center gap-3 rounded-lg bg-foreground/5 p-3">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-[11px] font-black uppercase tracking-widest text-muted-foreground">{{ $t('posts.form.linkedin.posting_to') }}</p>
            ...
            <div class="space-y-2">
                <p class="text-[11px] font-black uppercase tracking-widest text-muted-foreground">{{ $t('posts.form.linkedin.document_title') }}</p>
                <Input
