...
return [
    ...
    */
    ...
    'flash' => [
        'welcome' => '欢迎使用 Dalil Tech Publish！',
        'welcome_trial' => '欢迎使用 Dalil Tech Publish！你的试用已开始。',
    ],

    'legal' => '继续即表示你同意我们的<a href="https://dalil-tech.com/terms" target="_blank">服务条款</a>和<a href="https://dalil-tech.com/privacy" target="_blank">隐私政策</a>。',
