...
return [
    ...
    'form' => [
        ...
        'tiktok' => [
            ...
            'creator_info' => [
                'unavailable' => 'Δεν ήταν δυνατή η φόρτωση των ρυθμίσεων δημοσίευσης αυτού του λογαριασμού TikTok, οπότε αυτή η ανάρτηση δεν μπορεί να δημοσιευτεί τώρα. Δοκιμάστε ξανά σε λίγα λεπτά.',
                'spam_risk_too_many_posts' => 'Το TikTok έχει διακόψει προσωρινά τις δημοσιεύσεις σε αυτόν τον λογαριασμό επειδή δημοσιεύτηκαν πολλές αναρτήσεις πρόσφατα. Δοκιμάστε ξανά αργότερα.',
                'spam_risk_user_banned_from_posting' => 'Το TikTok έχει αποκλείσει αυτόν τον λογαριασμό από τις δημοσιεύσεις, οπότε αυτή η ανάρτηση δεν μπορεί να δημοσιευτεί.',
                'reached_active_user_cap' => 'Το TikTok έφτασε το ημερήσιο όριο ενεργών χρηστών για αυτήν την εφαρμογή. Δοκιμάστε ξανά αύριο.',
            ],
