...
return [
    ...
    'authentication' => [
        ...
        'providers' => [
            ...
            'description' => 'سجّل الدخول بشكل أسرع عبر المزوّدين المتصلين.',
            'connected' => 'متصل',
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}سيفقد عضو آخر واحد الوصول. الأعضاء الذين ليس لديهم مساحة عمل أخرى في Dalil Tech Publish سيُحذف حسابهم نهائيًا.|[2,*]سيفقد :count أعضاء آخرين الوصول. الأعضاء الذين ليس لديهم مساحة عمل أخرى في Dalil Tech Publish سيُحذف حسابهم نهائيًا.',
    ...
    'members' => [
        ...
        'errors' => [
            ...
            'email_belongs_to_account' => 'هذا البريد الإلكتروني ينتمي بالفعل إلى حساب Dalil Tech Publish آخر. اطلب بريد عمل مخصص بدلاً من ذلك.',
        ],
    ...
    'api_keys' => [
        ...
        'copy' => 'نسخ',
        'new_token_message' => 'تم إنشاء مفتاح API الجديد. انسخه الآن، فلن تتمكن من رؤيته مرة أخرى.',
        'table' => [
            'name' => 'الاسم',
            'key' => 'المفتاح',
            'status' => 'الحالة',
