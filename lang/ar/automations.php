...
return [
    ...
    'invocations' => [
        ...
        'refresh' => 'تحديث',
        'search_placeholder' => 'البحث حسب معرّف التشغيل…',
    ...
    'test' => [
        ...
        'node_error' => 'خطأ',
        'no_new_items' => 'لا توجد عناصر جديدة، لذا لم يُشغَّل أي شيء لاحق.',
    ...
    'config' => [
        ...
        'trigger' => [
            ...
            'post_published_hint' => 'يعمل كلما تم نشر أي منشور في مساحة العمل هذه. يصبح المنشور متاحًا في {{ trigger.post }} للعقد اللاحقة.',
        ...
        'http_request' => [
            ...
            'item_key_path_hint' => 'مسار JSON لمعرّف فريد (مثل id). تُتخطى العناصر التي سبقت رؤيتها، لذا حتى الخلاصة التي بلا تواريخ لا تُمرّر إلا الإدخالات الجديدة.',
    ...
    'errors' => [
        ...
        'webhook_missing_url' => 'عقدة Webhook ينقصها رابط.',
        ...
        'fetch_rss_missing_url' => 'عقدة جلب RSS ينقصها رابط خلاصة.',
        'fetch_rss_request_failed' => 'فشل طلب خلاصة RSS.',
        'fetch_rss_malformed' => 'خلاصة RSS مشوّهة.',
        'http_missing_url' => 'عقدة طلب HTTP ينقصها رابط.',
