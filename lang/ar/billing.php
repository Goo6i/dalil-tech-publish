...
return [
    ...
    'annual_banner' => [
        ...
        'description' => 'انتقل إلى الفوترة السنوية وادفع أقل كل شهر، بنفس الخطة ودون أي تغيير آخر.',
    ...
    'flash' => [
        ...
        'credits_exhausted' => 'نفد رصيد الذكاء الاصطناعي. تم استخدام مخصصك الشهري البالغ :limit. قم بترقية خطتك أو انتظر حتى الشهر المقبل.',
    ...
    'processing' => [
        ...
        'cancelled_description' => 'تم إلغاء عملية الدفع. لم يتم خصم أي مبلغ.',
